...
public class NeighborTest {
    ...
    private StopWatch methodStopWatch = new StopWatch();
    ...
    @After
    public void stop(){
        System.out.println(String.format("Took: %s seconds", (double)methodStopWatch.elapsedTime()/1000));
    }

    @Test
    public void testGraph001() throws IOException {
        Graph graph = GraphReader.readGraph("graph001.txt", edgesReader);
        Edges solution = Neighbor.solve(graph);
